...
| 115 | [LightRAG](https://github.com/HKUDS/LightRAG) | ⭐ 13.2k | "LightRAG: Simple and Fast Retrieval-Augmented Generation" |
...
| 128 | [llmware](https://github.com/llmware-ai/llmware) | ⭐ 12.0k | Unified framework for building enterprise RAG pipelines with small, specialized models |
| 129 | [gorilla](https://github.com/ShishirPatil/gorilla) | ⭐ 11.9k | Gorilla: Training and Evaluating LLMs for Function Calls (Tool Calls) |
...
| 156 | [langfuse](https://github.com/langfuse/langfuse) | ⭐ 9.8k | 🪢 Open source LLM engineering platform: LLM Observability, metrics, evals, prompt management, playground, datasets. Integrates with OpenTelemetry, Langchain, OpenAI SDK, LiteLLM, and more. 🍊YC W23  |
...
| 190 | [gitingest](https://github.com/cyclotruc/gitingest) | ⭐ 7.7k | Replace 'hub' with 'ingest' in any github url to get a prompt-friendly extract of a codebase  |
...
| 283 | [agents](https://github.com/livekit/agents) | ⭐ 5.4k | A powerful framework for building realtime voice AI agents 🤖🎙️📹  |
